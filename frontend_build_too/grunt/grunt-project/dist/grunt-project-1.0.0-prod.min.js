import e from "maxmin";

const t = "function smoothRangeRandom(min,max){var num=Math.floor(Math.random()*(max-min+1)+min);return this.prev=num===this.prev?++num:num};", n = "(function(b,c){var a=Math.floor(Math.random()*(c-b+1)+b);return this.a=a===this.a?++a:a})()";
...
!function(e, t) {
  ...
  }, W = t.push, F = t.indexOf, B = {}, $ = B.toString, _ = B.hasOwnProperty, z = _.toString, U = z.call(Object), g = {}, v = function(e) {
  ...
  E.fn = E.prototype = {
    ...
    i = r && !Array.isArray(i) ? [] : r || E.isPlainObject(i) ? i : {}, r = !1, 
  ...
  var e = function(R) {
    var r, p, b, o, M, d, I, W, w, u, l, T, C, n, E, h, i, a, g, S = "sizzle" + +new Date(), c = R.document, k = 0, F = 0, B = q(), $ = q(), _ = q(), m = q(), z = function(e, t) {
      return e === t && (l = !0), 0;
    }, U = {}.hasOwnProperty, e = [], X = e.pop, V = e.push, A = e.push, G = e.slice, v = function(e, t) {
      for (var n = 0, r = e.length; n < r; n++) if (e[n] === t) return n;
      return -1;
    }, Y = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", s = "[\\x20\\t\\r\\n\\f]", t = "(?:\\\\[\\da-fA-F]{1,6}" + s + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", Q = "\\[" + s + "*(" + t + ")(?:" + s + "*([*^$|!~]?=)" + s + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + t + "))|)" + s + "*\\]", J = ":(" + t + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + Q + ")*)|.*)\\)|)", K = new RegExp(s + "+", "g"), y = new RegExp("^" + s + "+|((?:^|[^\\\\])(?:\\\\.)*)" + s + "+$", "g"), Z = new RegExp("^" + s + "*," + s + "*"), ee = new RegExp("^" + s + "*([>+~]|" + s + ")" + s + "*"), te = new RegExp(s + "|>"), ne = new RegExp(J), re = new RegExp("^" + t + "$"), f = {
      ID: new RegExp("^#(" + t + ")"),
      CLASS: new RegExp("^\\.(" + t + ")"),
      TAG: new RegExp("^(" + t + "|[*])"),
      ATTR: new RegExp("^" + Q),
    ...
    }, ie = /HTML$/i, oe = /^(?:input|select|textarea|button)$/i, ae = /^h\d$/i, x = /^[^{]+\{\s*\[native \w/, se = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ue = /[+~]/, N = new RegExp("\\\\[\\da-fA-F]{1,6}" + s + "?|\\\\([^\\r\\n\\f])", "g"), j = function(e, t) {
      e = "0x" + e.slice(1) - 65536;
      return t || (e < 0 ? String.fromCharCode(65536 + e) : String.fromCharCode(e >> 10 | 55296, 1023 & e | 56320));
    }, le = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ce = function(e, t) {
    ...
    try {
      A.apply(e = G.call(c.childNodes), c.childNodes), e[c.childNodes.length].nodeType;
    } catch (r) {
      A = {
    ...
    function D(e, t, n, r) {
      ...
      if (!r && (T(t), t = t || C, E)) {
        if (11 !== f && (s = se.exec(e))) if (i = s[1]) {
          if (9 === f) {
            if (!(l = t.getElementById(i))) return n;
            if (l.id === i) return n.push(l), n;
          } else if (c && (l = c.getElementById(i)) && g(t, l) && l.id === i) return n.push(l), 
          n;
        } else {
          if (s[2]) return A.apply(n, t.getElementsByTagName(e)), n;
          if ((i = s[3]) && p.getElementsByClassName && t.getElementsByClassName) return A.apply(n, t.getElementsByClassName(i)), 
          n;
        }
        if (p.qsa && !m[e + " "] && (!h || !h.test(e)) && (1 !== f || "object" !== t.nodeName.toLowerCase())) {
          if (l = e, c = t, 1 === f && (te.test(e) || ee.test(e))) {
            for ((c = ue.test(e) && me(t.parentNode) || t) === t && p.scope || ((a = t.getAttribute("id")) ? a = a.replace(le, ce) : t.setAttribute("id", a = S)), 
            o = (u = d(e)).length; o--; ) u[o] = (a ? "#" + a : ":scope") + " " + P(u[o]);
            l = u.join(",");
          }
          try {
    ...
    for (r in p = D.support = {}, M = D.isXML = function(e) {
      ...
      E = !M(C), c != C && (e = C.defaultView) && e.top !== e && (e.addEventListener ? e.addEventListener("unload", fe, !1) : e.attachEvent && e.attachEvent("onunload", fe)), 
      p.scope = H(function(e) {
        return n.appendChild(e).appendChild(C.createElement("div")), "undefined" != typeof e.querySelectorAll && !e.querySelectorAll(":scope fieldset div").length;
      }), p.attributes = H(function(e) {
        return e.className = "i", !e.getAttribute("className");
      }), p.getElementsByTagName = H(function(e) {
        return e.appendChild(C.createComment("")), !e.getElementsByTagName("*").length;
      }), p.getElementsByClassName = x.test(C.getElementsByClassName), p.getById = H(function(e) {
      ...
      }, i = [], h = [], (p.qsa = x.test(C.querySelectorAll)) && (H(function(e) {
        var t;
        ...
        e.querySelectorAll("[selected]").length || h.push("\\[" + s + "*(?:value|" + Y + ")"), 
        e.querySelectorAll("[id~=" + S + "-]").length || h.push("~="), (t = C.createElement("input")).setAttribute("name", ""), 
        e.appendChild(t), e.querySelectorAll("[name='']").length || h.push("\\[" + s + "*name" + s + "*=" + s + "*(?:''|\"\")"), 
      ...
      })), (p.matchesSelector = x.test(a = n.matches || n.webkitMatchesSelector || n.mozMatchesSelector || n.oMatchesSelector || n.msMatchesSelector)) && H(function(e) {
        p.disconnectedMatch = a.call(e, "*"), a.call(e, "[s!='']:x"), i.push("!=", J);
      }), h = h.length && new RegExp(h.join("|")), i = i.length && new RegExp(i.join("|")), 
      e = x.test(n.compareDocumentPosition), g = e || x.test(n.contains) ? function(e, t) {
      ...
      if (T(e), p.matchesSelector && E && !m[t + " "] && (!i || !i.test(t)) && (!h || !h.test(t))) try {
        var n = a.call(e, t);
      ...
      var n = b.attrHandle[t.toLowerCase()], n = n && U.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !E) : void 0;
      ...
      var t, n = [], r = 0, i = 0;
      if (l = !p.detectDuplicates, u = !p.sortStable && e.slice(0), e.sort(z), l) {
      ...
      preFilter: {
        ATTR: function(e) {
          return e[1] = e[1].replace(N, j), e[3] = (e[3] || e[4] || e[5] || "").replace(N, j), 
          "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4);
        },
        CHILD: function(e) {
          return e[1] = e[1].toLowerCase(), "nth" === e[1].slice(0, 3) ? (e[3] || D.error(e[0]), 
          e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])), 
          e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && D.error(e[0]), e;
        },
        PSEUDO: function(e) {
          var t, n = !e[6] && e[2];
          return f.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && ne.test(n) && (t = d(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), 
          e[2] = n.slice(0, t)), e.slice(0, 3));
        }
      },
      filter: {
        TAG: function(e) {
          var t = e.replace(N, j).toLowerCase();
          return "*" === e ? function() {
            return !0;
          } : function(e) {
      ...
      pseudos: {
        ...
        contains: L(function(t) {
          return t = t.replace(N, j), function(e) {
            return -1 < (e.textContent || o(e)).indexOf(t);
          };
        }),
        lang: L(function(n) {
          return re.test(n || "") || D.error("unsupported lang: " + n), n = n.replace(N, j).toLowerCase(), 
          function(e) {
            var t;
            do {
    ...
    function we(e) {
      for (var r, t, n, i = e.length, o = b.relative[e[0].type], a = o || b.relative[" "], s = o ? 1 : 0, u = ve(function(e) {
        ...
        if ((t = b.filter[e[s].type].apply(null, e[s].matches))[S]) {
          ...
          return function f(d, h, g, m, y, e) {
            return m && !m[S] && (m = f(m)), y && !y[S] && (y = f(y, e)), L(function(e, t, n, r) {
              var i, o, a, s = [], u = [], l = t.length, c = e || function(e, t, n) {
                for (var r = 0, i = t.length; r < i; r++) D(e, t[r], n);
                return n;
              }(h || "*", n.nodeType ? [ n ] : n, []), f = !d || !e && h ? c : be(c, s, d, n, r), p = g ? y || (e ? d : l || m) ? [] : t : f;
              ...
              if (e) {
                if (y || d) {
                  ...
                  for (o = p.length; o--; ) (a = p[o]) && -1 < (i = y ? v(e, a) : s[o]) && (e[i] = !(t[i] = a));
                }
              } else p = be(p === t ? p.splice(l, p.length) : p), y ? y(null, t, p, r) : A.apply(t, p);
            });
          }(1 < s && xe(c), 1 < s && P(e.slice(0, s - 1).concat({
            value: " " === e[s - 2].type ? "*" : ""
          })).replace(y, "$1"), t, s < n && we(e.slice(s, n)), n < i && we(e = e.slice(n)), n < i && P(e));
        }
        c.push(t);
      }
      return xe(c);
    ...
    return ye.prototype = b.filters = b.pseudos, b.setFilters = new ye(), d = D.tokenize = function(e, t) {
      ...
      for (a = e, s = [], u = b.preFilter; a; ) {
        ...
        s.push(i = [])), n = !1, (r = ee.exec(a)) && (n = r.shift(), i.push({
          value: n,
          type: r[0].replace(y, " ")
        }), a = a.slice(n.length)), b.filter) !(r = f[o].exec(a)) || u[o] && !(r = u[o](r)) || (n = r.shift(), 
        i.push({
          value: n,
          type: o,
          matches: r
      ...
      return t ? a.length : a ? D.error(e) : $(e, s).slice(0);
    }, I = D.compile = function(e, t) {
      var n, m, y, v, x, r, i = [], o = [], a = _[e + " "];
      if (!a) {
        for (n = (t = t || d(e)).length; n--; ) ((a = we(t[n]))[S] ? i : o).push(a);
        (a = _(e, (v = 0 < (y = i).length, x = 0 < (m = o).length, r = function(e, t, n, r, i) {
          ...
          if (u += l, v && l !== u) {
            ...
            A.apply(r, f), i && !e && 0 < f.length && 1 < u + y.length && D.uniqueSort(r);
          }
          return i && (k = h, w = p), c;
        }, v ? L(r) : r))).selector = e;
      }
      return a;
    }, W = D.select = function(e, t, n, r) {
      var i, o, a, s, u, l = "function" == typeof e && e, c = !r && d(e = l.selector || e);
      if (n = n || [], 1 === c.length) {
        if (2 < (o = c[0] = c[0].slice(0)).length && "ID" === (a = o[0]).type && 9 === t.nodeType && E && b.relative[o[1].type]) {
          if (!(t = (b.find.ID(a.matches[0].replace(N, j), t) || [])[0])) return n;
          l && (t = t.parentNode), e = e.slice(o.shift().value.length);
        }
        for (i = f.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !b.relative[s = a.type]); ) if ((u = b.find[s]) && (r = u(a.matches[0].replace(N, j), ue.test(o[0].type) && me(t.parentNode) || t))) {
          if (o.splice(i, 1), e = r.length && P(o)) break;
          return A.apply(n, r), n;
        }
      }
      return (l || I(e, c))(r, t, !E, n, !t || ue.test(e) && me(t.parentNode) || t), 
      n;
    }, p.sortStable = S.split("").sort(z).join("") === S, p.detectDuplicates = !!l, 
  ...
  }(T), r = (E.find = e, E.expr = e.selectors, E.expr[":"] = E.expr.pseudos, E.uniqueSort = E.unique = e.uniqueSort, 
  E.text = e.getText, E.isXMLDoc = e.isXML, E.contains = e.contains, E.escapeSelector = e.escape, 
  function(e, t, n) {
  ...
  var Z, ee = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, te = ((E.fn.init = function(e, t, n) {
    ...
    if (r[1]) {
      if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : C, !0)), 
      J.test(r[1]) && E.isPlainObject(t)) for (var r in t) v(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
      return this;
    }
    return (n = C.getElementById(r[2])) && (this[0] = n, this.length = 1), this;
  }).prototype = E.fn, Z = E(C), /^(?:parents|prev(?:Until|All))/), ne = {
    children: !0,
    contents: !0,
    next: !0,
    prev: !0
  ...
  E.fn.extend({
    ...
    E.fn[r] = function(e, t) {
      ...
      1 < this.length && (ne[r] || E.uniqueSort(n), te.test(r) && n.reverse()), 
      this.pushStack(n);
    };
  });
  var S = /[^\x20\t\r\n\f]+/g;
  ...
  E.Callbacks = function(n) {
    var e, r;
    n = "string" == typeof n ? (e = n, r = {}, E.each(e.match(S) || [], function(e, t) {
      r[t] = !0;
    }), r) : E.extend({}, n);
    var i, t, o, a, s = [], u = [], l = -1, c = function() {
      for (a = a || n.once, o = i = !0; u.length; l = -1) for (t = u.shift(); ++l < s.length; ) !1 === s[l].apply(t[0], t[1]) && n.stopOnFalse && (l = s.length, 
      t = !1);
      n.memory || (t = !1), i = !1, a && (s = t ? [] : "");
    }, f = {
      add: function() {
        return s && (t && !i && (l = s.length - 1, u.push(t)), function r(e) {
          E.each(e, function(e, t) {
            v(t) ? n.unique && f.has(t) || s.push(t) : t && t.length && "string" !== h(t) && r(t);
          });
            ...
            return function() {
              var n = this, r = arguments, e = function() {
                ...
                if (!(i < u)) {
                  ...
                  v(t) ? s ? t.call(e, l(u, o, c, s), l(u, o, ie, s)) : (u++, t.call(e, l(u, o, c, s), l(u, o, ie, s), l(u, o, c, o.notifyWith))) : (a !== c && (n = void 0, 
                ...
                try {
                  ...
                  u <= i + 1 && (a !== ie && (n = void 0, r = [ e ]), o.rejectWith(n, r));
                }
              };
    ...
    when: function(e) {
      ...
      if (n <= 1 && (oe(e, o.done(a(t)).resolve, o.reject, !n), "pending" === o.state() || v(i[t] && i[t].then))) return o.then();
      for (;t--; ) oe(i[t], a(t), o.reject);
      return o.promise();
    }
  });
  var ae = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/, se = (E.Deferred.exceptionHook = function(e, t) {
  ...
  function ue() {
    C.removeEventListener("DOMContentLoaded", ue), T.removeEventListener("load", ue), 
    E.ready();
  }
  ...
  }), E.ready.then = se.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? T.setTimeout(E.ready) : (C.addEventListener("DOMContentLoaded", ue), 
  ...
  E.extend({
    ...
    queue: function(e, t, n) {
      var r;
      if (e) return r = b.get(e, t = (t || "fx") + "queue"), n && (!r || Array.isArray(n) ? r = b.access(e, t, E.makeArray(n)) : r.push(n)), 
      r || [];
    },
    ...
    promise: function(e, t) {
      ...
      for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--; ) (n = b.get(o[a], e + "queueHooks")) && n.empty && (r++, 
      n.empty.add(s));
      return s(), i.promise(t);
    }
  });
  var e = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, me = new RegExp("^(?:([+-])=|)(" + e + ")([a-z%]*)$", "i"), p = [ "Top", "Right", "Bottom", "Left" ], w = C.documentElement, k = function(e) {
    return E.contains(e.ownerDocument, e);
  }, ye = {
    composed: !0
  }, ve = (w.getRootNode && (k = function(e) {
  ...
  function xe(e, t, n, r) {
    ...
    if (c && c[3] !== l) {
      for (l = l || c[3], c = +(u /= 2) || 1; a--; ) E.style(e, t, c + l), (1 - o) * (1 - (o = s() / u || .5)) <= 0 && (a = 0), 
      c /= o;
  ...
  function A(e, t) {
    ...
    t ? ("none" === n && (u[l] = b.get(r, "display") || null, u[l] || (r.style.display = "")), 
    "" === r.style.display && ve(r) && (u[l] = (s = o = i = void 0, o = r.ownerDocument, 
    a = r.nodeName, (s = be[a]) || (i = o.body.appendChild(o.createElement(a)), 
    s = E.css(i, "display"), i.parentNode.removeChild(i), be[a] = s = "none" === s ? "block" : s)))) : "none" !== n && (u[l] = "none", 
    b.set(r, "display", n)));
  ...
  var we = /^(?:checkbox|radio)$/i, Te = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, Ce = /^$|^module$|\/(?:java|ecma)script/i, n = C.createDocumentFragment().appendChild(C.createElement("div")), N = ((L = C.createElement("input")).setAttribute("type", "radio"), 
  L.setAttribute("checked", "checked"), L.setAttribute("name", "t"), n.appendChild(L), 
  g.checkClone = n.cloneNode(!0).cloneNode(!0).lastChild.checked, n.innerHTML = "<textarea>x</textarea>", 
  g.noCloneChecked = !!n.cloneNode(!0).lastChild.defaultValue, n.innerHTML = "<option></option>", 
  ...
  function ke(e, t, n, r, i) {
    for (var o, a, s, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; p < d; p++) if ((o = e[p]) || 0 === o) if ("object" === h(o)) E.merge(f, o.nodeType ? [ o ] : o); else if (Se.test(o)) {
      ...
      s = N[s] || N._default, a.innerHTML = s[1] + E.htmlPrefilter(o) + s[2], l = s[0]; l--; ) a = a.lastChild;
      E.merge(f, a.childNodes), (a = c.firstChild).textContent = "";
    } else f.push(t.createTextNode(o));
    for (c.textContent = "", p = 0; o = f[p++]; ) if (r && -1 < E.inArray(o, r)) i && i.push(o); else if (u = k(o), 
  ...
  E.event = {
    ...
    add: function(t, e, n, r, i) {
      ...
      if (y(t)) for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(w, i), 
      n.guid || (n.guid = E.guid++), (s = h.events) || (s = h.events = Object.create(null)), 
      (a = h.handle) || (a = h.handle = function(e) {
        return void 0 !== E && E.event.triggered !== e.type ? E.event.dispatch.apply(t, arguments) : void 0;
      }), u = (e = (e || "").match(S) || [ "" ]).length; u--; ) f = d = (p = Ae.exec(e[u]) || [])[1], 
      p = (p[2] || "").split(".").sort(), f && (l = E.event.special[f] || {}, f = (i ? l.delegateType : l.bindType) || f, 
      l = E.event.special[f] || {}, d = E.extend({
        type: f,
        origType: d,
        data: r,
        handler: n,
      ...
      i ? c.splice(c.delegateCount++, 0, d) : c.push(d), E.event.global[f] = !0);
    },
    remove: function(e, t, n, r, i) {
      var o, a, s, u, l, c, f, p, d, h, g, m = b.hasData(e) && b.get(e);
      if (m && (u = m.events)) {
        for (l = (t = (t || "").match(S) || [ "" ]).length; l--; ) if (d = g = (s = Ae.exec(t[l]) || [])[1], 
        h = (s[2] || "").split(".").sort(), d) {
          ...
          a && !p.length && (f.teardown && !1 !== f.teardown.call(e, h, m.handle) || E.removeEvent(e, d, m.handle), 
          delete u[d]);
    ...
    dispatch: function(e) {
      ...
      if (s.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, s)) {
        for (o = E.event.handlers.call(this, s, e), t = 0; (r = o[t++]) && !s.isPropagationStopped(); ) for (s.currentTarget = r.elem, 
        ...
        s.data = i.data, void 0 !== (i = ((E.event.special[i.origType] || {}).handle || i.handler).apply(r.elem, a)) && !1 === (s.result = i) && (s.preventDefault(), 
        s.stopPropagation()));
    ...
    e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? a : d, 
  ...
  function Me(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      o) for (n = 0, r = o[i].length; n < r; n++) E.event.add(t, i, o[i][n]);
  ...
  function D(n, r, i, o) {
    ...
    if (h || 1 < f && "string" == typeof d && !g.checkClone && Le.test(d)) return n.each(function(e) {
      var t = n.eq(e);
      h && (r[0] = d.call(this, e, t.html())), D(t, r, i, o);
    });
    if (f && (t = (e = ke(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), 
    t || o)) {
      for (s = (a = E.map(j(e, "script"), Pe)).length; c < f; c++) u = e, c !== p && (u = E.clone(u, !0, !0), 
      s && E.merge(a, j(u, "script"))), i.call(n[c], u, c);
      if (s) for (l = a[a.length - 1].ownerDocument, E.map(a, Re), c = 0; c < s; c++) u = a[c], 
  ...
  E.extend({
    ...
    clone: function(e, t, n) {
      ...
      if (!(g.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e))) for (a = j(c), 
      r = 0, i = (o = j(e)).length; r < i; r++) s = o[r], "input" === (l = (u = a[r]).nodeName.toLowerCase()) && we.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
    ...
    empty: function() {
      for (var e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (E.cleanData(j(e, !1)), 
      e.textContent = "");
      return this;
    },
    clone: function(e, t) {
    ...
    html: function(e) {
      return f(this, function(e) {
        ...
        if ("string" == typeof e && !qe.test(e) && !N[(Te.exec(e) || [ "", "" ])[1].toLowerCase()]) {
          e = E.htmlPrefilter(e);
          try {
            for (;n < r; n++) 1 === (t = this[n] || {}).nodeType && (E.cleanData(j(t, !1)), 
            t.innerHTML = e);
            t = 0;
          } catch (e) {}
        }
    ...
    E.fn[e] = function(e) {
      ...
      E(r[o])[a](t), W.apply(n, t.get());
      return this.pushStack(n);
    };
  });
  var We, Fe, Be, $e, _e, ze, Ue, i, Xe = new RegExp("^(" + e + ")(?!px)[a-z%]+$", "i"), Ve = function(e) {
  ...
  function Qe(e, t, n) {
    var r, i, o = e.style;
    return (n = n || Ve(e)) && ("" !== (i = n.getPropertyValue(t) || n[t]) || k(e) || (i = E.style(e, t)), 
    !g.pixelBoxStyles() && Xe.test(i) && Ye.test(t) && (e = o.width, t = o.minWidth, 
  ...
  function Ke() {
    var e;
    i && (Ue.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", 
    ...
    w.appendChild(Ue).appendChild(i), e = T.getComputedStyle(i), We = "1%" !== e.top, 
    ze = 12 === Ze(e.marginLeft), i.style.right = "60%", $e = 36 === Ze(e.right), 
    Fe = 36 === Ze(e.width), i.style.position = "absolute", Be = 12 === Ze(i.offsetWidth / 3), 
    w.removeChild(Ue), i = null);
  }
  function Ze(e) {
    return Math.round(parseFloat(e));
  }
  Ue = C.createElement("div"), (i = C.createElement("div")).style && (i.style.backgroundClip = "content-box", 
  ...
  E.extend(g, {
    ...
    reliableTrDimensions: function() {
      var e, t, n;
      return null == _e && (e = C.createElement("table"), t = C.createElement("tr"), 
      ...
      n.style.display = "block", w.appendChild(e).appendChild(t).appendChild(n), 
      n = T.getComputedStyle(t), _e = parseInt(n.height, 10) + parseInt(n.borderTopWidth, 10) + parseInt(n.borderBottomWidth, 10) === t.offsetHeight, 
      w.removeChild(e)), _e;
    }
  }));
  ...
  function lt(e, t, n, r, i, o) {
    ...
    for (;a < 4; a += 2) "margin" === n && (u += E.css(e, n + p[a], !0, i)), r ? ("content" === n && (u -= E.css(e, "padding" + p[a], !0, i)), 
  ...
  function ct(e, t, n) {
    var r = Ve(e), i = (!g.boxSizingReliable() || n) && "border-box" === E.css(e, "boxSizing", !1, r), o = i, a = Qe(e, t, r), s = "offset" + t[0].toUpperCase() + t.slice(1);
    if (Xe.test(a)) {
      if (!n) return a;
      a = "auto";
    }
    return (!g.boxSizingReliable() && i || !g.reliableTrDimensions() && u(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === E.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === E.css(e, "boxSizing", !1, r), 
  ...
  E.extend({
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        o = "number"), null != n && n == n && ("number" !== o || u || (n += i && i[3] || (E.cssNumber[s] ? "" : "px")), 
    ...
    css: function(e, t, n, r) {
      var i, o = x(t);
      return ot.test(t) || (t = rt(o)), "normal" === (i = void 0 === (i = (o = E.cssHooks[t] || E.cssHooks[o]) && "get" in o ? o.get(e, !0, n) : i) ? Qe(e, t, r) : i) && t in st && (i = st[t]), 
      "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
    }
  }), E.each([ "height", "width" ], function(e, a) {
    E.cssHooks[a] = {
      get: function(e, t, n) {
        if (t) return !it.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ct(e, a, n) : Ge(e, at, function() {
          return ct(e, a, n);
        });
      },
      set: function(e, t, n) {
        var r = Ve(e), i = !g.scrollboxSize() && "absolute" === r.position, o = (i || n) && "border-box" === E.css(e, "boxSizing", !1, r), n = n ? lt(e, a, n, o, r) : 0;
    ...
    css: function(e, t) {
      return f(this, function(e, t, n) {
        var r, i, o = {}, a = 0;
        if (Array.isArray(t)) {
          for (r = Ve(e), i = t.length; a < i; a++) o[t[a]] = E.css(e, t[a], !1, r);
          return o;
        }
  ...
  function H(i, e, t) {
    ...
    for (r in m) if (s = y[a = x(r)], u = m[r], Array.isArray(u) && (s = u[1], u = m[r] = u[0]), 
    r !== a && (m[a] = u, delete m[r]), (l = E.cssHooks[a]) && "expand" in l) for (r in u = l.expand(u), 
    delete m[a], u) r in m || (m[r] = u[r], y[r] = s); else y[a] = s;
    for (;c < f; c++) if (n = H.prefilters[c].call(h, i, g, h.opts)) return v(n.stop) && (E._queueHooks(h.elem, h.opts.queue).stop = n.stop.bind(n)), 
    n;
    return E.map(g, yt, h), v(h.opts.start) && h.opts.start.call(i, h), h.progress(h.opts.progress).done(h.opts.done, h.opts.complete).fail(h.opts.fail).always(h.opts.always), 
  ...
  E.Animation = E.extend(H, {
    ...
    tweener: function(e, t) {
      for (var n, r = 0, i = (e = v(e) ? (t = e, [ "*" ]) : e.match(S)).length; r < i; r++) n = e[r], 
      H.tweeners[n] = H.tweeners[n] || [], H.tweeners[n].unshift(t);
    },
    prefilters: [ function(e, t, n) {
      var r, i, o, a, s, u, l, c = "width" in t || "height" in t, f = this, p = {}, d = e.style, h = e.nodeType && ve(e), g = b.get(e, "fxshow");
      ...
      if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(p)) for (r in c && 1 === e.nodeType && (n.overflow = [ d.overflow, d.overflowX, d.overflowY ], 
      null == (l = g && g.display) && (l = b.get(e, "display")), "none" === (c = E.css(e, "display")) && (l ? c = l : (A([ e ], !0), 
      l = e.style.display || l, c = E.css(e, "display"), A([ e ]))), ("inline" === c || "inline-block" === c && null != l) && "none" === E.css(e, "float") && (u || (f.done(function() {
        d.display = l;
    ...
    animate: function(t, e, n, r) {
      var i = E.isEmptyObject(t), o = E.speed(e, n, r), e = function() {
        var e = H(this, E.extend({}, t), o);
  ...
  }, L = C.createElement("input"), n = C.createElement("select").appendChild(C.createElement("option")), 
  L.type = "checkbox", g.checkOn = "" !== L.value, g.optSelected = n.selected, (L = C.createElement("input")).value = "t", 
  L.type = "radio", g.radioValue = "t" === L.value;
  var vt, xt = E.expr.attrHandle, bt = (E.fn.extend({
    ...
    attr: function(e, t, n) {
      ...
      if (3 !== o && 8 !== o && 2 !== o) return "undefined" == typeof e.getAttribute ? E.prop(e, t, n) : (1 === o && E.isXMLDoc(e) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? vt : void 0)), 
    ...
    attrHooks: {
      type: {
        set: function(e, t) {
          var n;
          if (!g.radioValue && "radio" === t && u(e, "input")) return n = e.value, 
  ...
  E.fn.extend({
    ...
    toggleClass: function(i, t) {
      ...
      return "boolean" == typeof t && a ? t ? this.addClass(i) : this.removeClass(i) : v(i) ? this.each(function(e) {
        ...
        var e, t, n, r;
        if (a) for (t = 0, n = E(this), r = Tt(i); e = r[t++]; ) n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else void 0 !== i && "boolean" != o || ((e = P(this)) && b.set(this, "__className__", e), 
  ...
  }), g.focusin = "onfocusin" in T, /^(?:focusinfocus|focusoutblur)$/), St = function(e) {
    e.stopPropagation();
  }, kt = (E.extend(E.event, {
    trigger: function(e, t, n, r) {
      var i, o, a, s, u, l, c, f = [ n || C ], p = _.call(e, "type") ? e.type : e, d = _.call(e, "namespace") ? e.namespace.split(".") : [], h = c = o = n = n || C;
      if (3 !== n.nodeType && 8 !== n.nodeType && !Et.test(p + E.event.triggered) && (-1 < p.indexOf(".") && (p = (d = p.split(".")).shift(), 
      d.sort()), s = p.indexOf(":") < 0 && "on" + p, (e = e[E.expando] ? e : new E.Event(p, "object" == typeof e && e)).isTrigger = r ? 2 : 3, 
      ...
      l = E.event.special[p] || {}, r || !l.trigger || !1 !== l.trigger.apply(n, t))) {
        if (!r && !l.noBubble && !m(n)) {
          for (a = l.delegateType || p, Et.test(a + p) || (h = h.parentNode); h; h = h.parentNode) f.push(h), 
          o = h;
        ...
        (u = s && h[s]) && u.apply && y(h) && (e.result = u.apply(h, t), !1 === e.result && e.preventDefault());
        return e.type = p, r || e.isDefaultPrevented() || l._default && !1 !== l._default.apply(f.pop(), t) || !y(n) || s && v(n[p]) && !m(n) && ((o = n[s]) && (n[s] = null), 
        E.event.triggered = p, e.isPropagationStopped() && c.addEventListener(p, St), 
        n[p](), e.isPropagationStopped() && c.removeEventListener(p, St), E.event.triggered = void 0, 
        o && (n[s] = o)), e.result;
      }
    },
  ...
  E.param = function(e, t) {
    ...
    if (Array.isArray(e) || e.jquery && !E.isPlainObject(e)) E.each(e, function() {
      ...
      if (Array.isArray(e)) E.each(e, function(e, t) {
        r || jt.test(n) ? i(n, t) : o(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, r, i);
      }); else if (r || "object" !== h(e)) i(n, e); else for (var t in e) o(n + "[" + t + "]", e[t], r, i);
    }(n, e[n], t, i);
    return r.join("&");
  }, E.fn.extend({
    serialize: function() {
  ...
  var Ht = /%20/g, Ot = /#.*$/, Pt = /([?&])_=[^&]*/, Rt = /^(.*?):[ \t]*([^\r\n]*)$/gm, Mt = /^(?:GET|HEAD)$/, It = /^\/\//, Wt = {}, Ft = {}, Bt = "*/".concat("*"), $t = C.createElement("a");
  function _t(o) {
    return function(e, t) {
  ...
  $t.href = kt.href, E.extend({
    ...
    ajax: function(e, t) {
      ...
      var u, l, c, n, f, p, d, r, i, h = E.ajaxSetup({}, t = t || {}), g = h.context || h, m = h.context && (g.nodeType || g.jquery) ? E(g) : E.event, y = E.Deferred(), v = E.Callbacks("once memory"), x = h.statusCode || {}, o = {}, a = {}, s = "canceled", b = {
        readyState: 0,
      ...
      if (y.promise(b), h.url = ((e || h.url || kt.href) + "").replace(It, kt.protocol + "//"), 
      ...
      delete h.data), !1 === h.cache && (l = l.replace(Pt, "$1"), i = (Nt.test(l) ? "&" : "?") + "_=" + At.guid++ + i), 
      h.url = l + i), h.ifModified && (E.lastModified[l] && b.setRequestHeader("If-Modified-Since", E.lastModified[l]), 
      E.etag[l] && b.setRequestHeader("If-None-Match", E.etag[l])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && b.setRequestHeader("Content-Type", h.contentType), 
      ...
      function w(e, t, n, r) {
        var i, o, a, s = t;
        p || (p = !0, f && T.clearTimeout(f), u = void 0, c = r || "", b.readyState = 0 < e ? 4 : 0, 
        ...
        }(h, a, b, r), r ? (h.ifModified && ((n = b.getResponseHeader("Last-Modified")) && (E.lastModified[l] = n), 
        (n = b.getResponseHeader("etag")) && (E.etag[l] = n)), 204 === e || "HEAD" === h.type ? s = "nocontent" : 304 === e ? s = "notmodified" : (s = a.state, 
        i = a.data, r = !(o = a.error))) : (o = s, !e && s || (s = "error", e < 0 && (e = 0))), 
        b.status = e, b.statusText = (t || s) + "", r ? y.resolveWith(g, [ i, s, b ]) : y.rejectWith(g, [ b, s, o ]), 
        b.statusCode(x), x = void 0, d && m.trigger(r ? "ajaxSuccess" : "ajaxError", [ b, h, r ? i : o ]), 
        v.fireWith(g, [ b, s ]), d && (m.trigger("ajaxComplete", [ b, h ]), --E.active || E.event.trigger("ajaxStop")));
      }
      return b;
    },
    ...
    wrapAll: function(e) {
      return this[0] && (v(e) && (e = e.call(this[0])), e = E(e, this[0].ownerDocument).eq(0).clone(!0), 
  ...
  g.cors = !!Vt && "withCredentials" in Vt, g.ajax = Vt = !!Vt, E.ajaxTransport(function(i) {
    var o, a;
    if (g.cors || Vt && !i.crossDomain) return {
      send: function(e, t) {
        var n, r = i.xhr();
  ...
  2 === e.childNodes.length), E.parseHTML = function(e, t, n) {
    ...
    t.head.appendChild(r)) : t = C), r = !n && [], (n = J.exec(e)) ? [ t.createElement(n[1]) ] : (n = ke([ e ], t, r), 
    r && r.length && E(r).remove(), E.merge([], n.childNodes)));
    var r;
    ...
    setOffset: function(e, t, n) {
      ...
      "static" === s && (e.style.position = "relative"), o = u.offset(), r = E.css(e, "top"), 
      a = E.css(e, "left"), s = ("absolute" === s || "fixed" === s) && -1 < (r + a).indexOf("auto") ? (i = (s = u.position()).top, 
      s.left) : (i = parseFloat(r) || 0, parseFloat(a) || 0), null != (t = v(t) ? t.call(e, n, E.extend({}, o)) : t).top && (l.top = t.top - o.top + i), 
    ...
    E.cssHooks[n] = Je(g.pixelPosition, function(e, t) {
      if (t) return t = Qe(e, n), Xe.test(t) ? E(e).position()[n] + "px" : t;
    });
  }), E.each({
    Height: "height",
    Width: "width"
    ...
    E.each({
      ...
      E.fn[o] = function(e, t) {
        ...
        return f(this, function(e, t, n) {
          var r;
          return m(e) ? 0 === o.indexOf("outer") ? e["inner" + a] : e.document.documentElement["client" + a] : 9 === e.nodeType ? (r = e.documentElement, 
  ...
  }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = u, E.isFunction = v, 
  E.isWindow = m, E.camelCase = x, E.type = h, E.now = Date.now, E.isNumeric = function(e) {
    var t = E.type(e);
